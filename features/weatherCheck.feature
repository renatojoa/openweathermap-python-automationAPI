...
#     Then I check cloud percent: <cloud>%
   ...
   Examples:
    ...
    | Zaragoza | 25.02 | 5.95   | 5.95     | 1026.02     | 97       | 800       | 10000      | 1.25          | 0    |
 ...
 Scenario Outline: Check weather in <city> and <country>
   ...
   Examples:
    ...
    | Recife   | BR      | 9.45  | 9.45    | 9.45    | 1026.02  | 97       | 800       | 10000      | 1.25       | 0     |
...
#     Then I check cloud percent: <cloud>%
   ...
   Examples:
    | cityID  | city    | temp  | minTemp | maxTemp | pressure | humidity | weatherID | visibility | windSpeed  | cloud |
    | 2643743 | London  | 15.22 | 13.33   | 17.22   | 1019     | 97       | 800       | 10000      | 1.25       | 0     |
...
#     Then I check cloud percent: <cloud>%
   ...
   Examples:
    | lat    | lon    | temp  | minTemp | maxTemp | pressure | humidity | weatherID | visibility | windSpeed  | cloud |
    | -28.48 | -48.99 | 15.22 | 13.33   | 17.22   | 1016.76  | 90       | 800       | 10000      | 1.25       | 0     |
 ...
 Scenario Outline: Check weather by zipcode <zip>
   ...
   Examples:
    | zip      | temp  | minTemp | maxTemp | pressure | humidity | weatherID | visibility | windSpeed  | cloud |
    | 50018,ES | 15.22 | 13.33   | 17.22   | 1016.76  | 74       | 800       | 10000      | 1.25       | 0     |